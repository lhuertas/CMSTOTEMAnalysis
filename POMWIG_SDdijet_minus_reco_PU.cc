...
void POMWIG_SDdijet_minus_reco_PU(string const& outputFileName = "pomwig_minus_rec_pu.root", const Int_t nevt_max = -1){
...
//   histosTH1F["decisionTechTrig"] = new TH1F("decisionTechTrig", "decisionTechTrig" , 64 , 0 , 64);
  ...
  histosTH1F["xi_proton_minus_rec"] = new TH1F("xi_proton_minus_rec", "xi_proton_minus" , 20, -0.1, 0.3);
  histosTH1F["xi_proton_minus_rec_accepted"] = new TH1F("xi_proton_minus_rec_accepted", "xi_proton_minus" , 20, 0., 0.3);
  ...
  histosTH1F["t_proton_minus_rec_accepted"] = new TH1F("t_proton_minus_rec_accepted", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_constbin"] = new TH1F("t_proton_minus_constbin", "t_proton_minus" , 20, 0, 1);
  ...
  histosTH1F["beta_proton_minus_accepted"] = new TH1F("beta_proton_minus_accepted", "beta_proton_minus" , 20, 0, 1 );
  histosTH1F["xi_proton_minus_signal"] = new TH1F("xi_proton_minus_signal", "xi_proton_minus" , 20, -0.1, 0.3);
  histosTH1F["xi_proton_minus_pu"] = new TH1F("xi_proton_minus_pu", "xi_proton_minus" , 20, -0.1, 0.3);
  histosTH1F["xi_proton_minus_mc&zb"] = new TH1F("xi_proton_minus_mc&zb", "xi_proton_minus" , 20, -0.1, 0.3);
  histosTH1F["t_proton_minus_signal"] = new TH1F("t_proton_minus_signal", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_pu"] = new TH1F("t_proton_minus_pu", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_mc&zb"] = new TH1F("t_proton_minus_mc&zb", "t_proton_minus" , 11, tbins);


  //FIXME
  histosTH1F["xi_proton_minus_accepted"] = new TH1F("xi_proton_minus_accepted", "xi_proton_minus" , 20, 0., 0.3);
  histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_accepted_constbin"] = new TH1F("t_proton_minus_accepted_constbin", "t_proton_minus" , 20, 0, 1);

  histosTH1F["xi_proton_minus_accepted_120"] = new TH1F("xi_proton_minus_accepted_120", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_120"] = new TH1F("t_proton_minus_accepted_120", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["posx_proton_minus_accepted_120"] = new TH1F("posx_proton_minus_accepted_120", "posx_proton_minus" , 20, -0.05, 0.05);
  histosTH1F["posy_proton_minus_accepted_120"] = new TH1F("posy_proton_minus_accepted_120", "posy_proton_minus" , 20, -0.05, 0.05);
  histosTH1F["t_proton_minus_accepted_121"] = new TH1F("t_proton_minus_accepted_121", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["xi_proton_minus_accepted_122"] = new TH1F("xi_proton_minus_accepted_122", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_122"] = new TH1F("t_proton_minus_accepted_122", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["xi_proton_minus_accepted_123"] = new TH1F("xi_proton_minus_accepted_123", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_123"] = new TH1F("t_proton_minus_accepted_123", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["xi_proton_minus_accepted_124"] = new TH1F("xi_proton_minus_accepted_124", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_124"] = new TH1F("t_proton_minus_accepted_124", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["xi_proton_minus_accepted_125"] = new TH1F("xi_proton_minus_accepted_125", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_125"] = new TH1F("t_proton_minus_accepted_125", "t_proton_minus" , 20, 0., 5.);
  histosTH1F["xi_proton_minus_accepted_020"] = new TH1F("xi_proton_minus_accepted_020", "xi_proton_minus" , 20, 0., 1.);
  histosTH1F["t_proton_minus_accepted_020"] = new TH1F("t_proton_minus_accepted_020", "t_proton_minus" , 20, 0., 5.);
...
//       histosTH1F["DeltaPhiJet"]->Fill( deltaphi, event_weight  );	
      ...
      double x_plus = ((Jet1_energy+Jet1_pz)+(Jet1_energy+Jet1_pz))/8000; 
      double x_minus = ((Jet2_energy-Jet2_pz)+(Jet2_energy-Jet2_pz))/8000; 
...
//	 if (eta_gen<4.9 && eta_gen>-4.9){ xi_posit_gen = true;
	 ...
	 if (pz_gen > proton_pz_plus) {
      ...
      if (fabs(t_proton_minus_rec)<0.03 || fabs(t_proton_minus_rec)>1)continue;
      if (xi_proton_minus_rec<0.03 || xi_proton_minus_rec>0.1)continue;
...
//      cout << "Random event, vtx valid, NDOF zero-bias: " << i_evt_ZB << ", " << zeroBiasData.vtx_valid << ", " << zeroBiasData.vtx_ndof << endl
//           << "Proton left vali, xi, t: " << zeroBiasData.proton_rec_left_valid << ", " << zeroBiasData.proton_rec_left_xi << ", " << zeroBiasData.proton_rec_left_t << endl
//           << "Proton right vali, xi, t: " << zeroBiasData.proton_rec_right_valid << ", " << zeroBiasData.proton_rec_right_xi << ", " << zeroBiasData.proton_rec_right_t << endl;    
 ...
 //     if (valid_vtx) continue;
      bool proton_zb = valid_proton_right_zb && (fabs(xi_proton_right_zb)>=0.03 && fabs(xi_proton_right_zb)<=0.1) && (fabs(t_proton_right_zb)>=0.03 && fabs(t_proton_right_zb)<=1);      
      //Decision proton from MC/ZB
      if(proton_minus_rp_accept && !proton_zb){
        histosTH1F["t_proton_minus_signal"]->Fill( fabs(t_proton_minus_rec) , event_weight );
        histosTH1F["xi_proton_minus_signal"]->Fill( xi_proton_minus_rec , event_weight );
      }

      if(!proton_minus_rp_accept && proton_zb){
        histosTH1F["t_proton_minus_pu"]->Fill( fabs(t_proton_right_zb) , event_weight );
        histosTH1F["xi_proton_minus_pu"]->Fill( xi_proton_right_zb , event_weight );
      }
      if(proton_minus_rp_accept && proton_zb){
        double xi_proton_minus_selec = (xi_proton_right_zb<xi_proton_minus_rec) ? xi_proton_right_zb : xi_proton_minus_rec;  
        double t_proton_minus_selec = (xi_proton_right_zb<xi_proton_minus_rec) ? t_proton_right_zb : t_proton_minus_rec;  
        histosTH1F["t_proton_minus_mc&zb"]->Fill( fabs(t_proton_minus_selec) , event_weight );
        histosTH1F["xi_proton_minus_mc&zb"]->Fill( xi_proton_minus_selec , event_weight );
      }

      //Plots after all selection
